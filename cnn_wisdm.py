...
fx = open("data_processing/wisdm_data/data_x_200.csv")
fy = open("data_processing/wisdm_data/data_y_200.csv")
fz = open("data_processing/wisdm_data/data_z_200.csv")
...
fx = open("data_processing/wisdm_data/data_x_test_200.csv")
fy = open("data_processing/wisdm_data/data_y_test_200.csv")
fz = open("data_processing/wisdm_data/data_z_test_200.csv")
data_x = np.loadtxt(fname = fx, delimiter = ',')
data_y = np.loadtxt(fname = fy, delimiter = ',')
data_z = np.loadtxt(fname = fz, delimiter = ',')
fx.close(); fy.close(); fz.close()
...
fa = open("data_processing/wisdm_data/answers_vectors_200.csv")
labels_train = np.loadtxt(fname = fa, delimiter = ',')
fa.close()

# Reading test labels

fa = open("data_processing/wisdm_data/answers_vectors_test_200.csv")
